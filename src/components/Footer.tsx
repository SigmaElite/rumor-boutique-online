        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 md:gap-8">
          ...
          <nav className="space-y-3">
            {footerLinks.column1.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="block text-sm tracking-wide opacity-90 hover:opacity-70 transition-opacity"
              >
                {link.label}
              </a>
            ))}
          ...
          <div className="space-y-4">
            <a
              ...
              className="block border border-primary-foreground/30 text-center py-3 text-sm tracking-widest uppercase hover:bg-primary-foreground/10 transition-colors"
            >
              Instagram
            </a>
