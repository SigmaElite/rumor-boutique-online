          ...
          <Tabs defaultValue="russia" className="w-full">
            ...
            <TabsContent value="russia" className="space-y-6">
              <div>
                ...
                <div className="space-y-2 text-muted-foreground">
                  <p>• Курьером до двери — <span className="font-medium text-foreground">60 <span className="font-script">byn</span> (1600 ₽)</span></p>
                  <p>• До отделения — <span className="font-medium text-foreground">40 <span className="font-script">byn</span> (1100 ₽)</span></p>
                </div>
              </div>
            </TabsContent>
            ...
            <TabsContent value="belarus" className="space-y-6">
              <div>
                ...
                <div className="space-y-2 text-muted-foreground">
                  <p>• Курьером до двери — <span className="font-medium text-foreground">30 <span className="font-script">byn</span></span></p>
                  <p>• До отделения — <span className="font-medium text-foreground">15 <span className="font-script">byn</span></span></p>
                </div>
              </div>
            </TabsContent>
            ...
            <TabsContent value="minsk" className="space-y-6">
              <div>
                ...
                <div className="space-y-2 text-muted-foreground">
                  ...
                  <p>• Если не выкупили — <span className="font-medium text-foreground">15 <span className="font-script">byn</span></span> стоимость доставки</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2 text-muted-foreground">
                  <p>• Без примерки — <span className="font-medium text-foreground">30 <span className="font-script">byn</span></span></p>
                  <p>• С примеркой — <span className="font-medium text-foreground">50 <span className="font-script">byn</span></span></p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2 text-muted-foreground">
                  <p>• С примеркой/без — <span className="font-medium text-foreground">100 <span className="font-script">byn</span></span></p>
                </div>
              </div>
            </TabsContent>
